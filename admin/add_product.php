<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if ($image_error == 0){
            ...
            $query = 'INSERT INTO products (name, description, images, slab_1_price, slab_2_price, slab_3_price) VALUES ("'.$name.'","'.$description.'", "'.$image_name.'", "'.$slab_1_price.'", "'.$slab_2_price.'", "'.$slab_3_price.'")';
                ...
                <div class="container-fluid">
                    <div class="row register-form">
                        <div class="col-md-8 offset-md-2">
                            <form class="custom-form" action="add_product.php" method="POST" enctype="multipart/form-data">
                                <h1>Add Product</h1>
                                <div class="row form-group">
                                    <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Name </label></div>
                                    <div class="col-sm-6 input-column"><input class="form-control" type="text" maxlength="100" name="name" required=""></div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Description</label></div>
                                    <div class="col-sm-6 input-column"><input class="form-control" type="text" name="description" required="" maxlength="500"></div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">images</label></div>
                                    <div class="col-sm-6 input-column">
                                        <div class="input-group">
                                            <div class="input-group-prepend"></div>
                                            <div class="custom-file"></div>
                                        </div><input class="form-control" type="file" name="image" accept="image/*" required="">
                                        <div class="custom-file"></div>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Slab 1 Price</label></div>
                                    <div class="col-sm-6 input-column"><input class="form-control" type="number" name="slab_1_price" min="0" required=""></div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Slab 2 Price</label></div>
                                    <div class="col-sm-6 input-column"><input class="form-control" type="number" name="slab_2_price" min="0" required=""></div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Slab 3 Price</label></div>
                                    <div class="col-sm-6 input-column"><input class="form-control" type="number" name="slab_3_price" min="0" required=""></div>
                                </div>
