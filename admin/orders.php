...
$table_search = "";
        ...
        if($table_search == ""){
            $query = "SELECT * FROM orders ORDER BY order_id DESC LIMIT {$offset},{$limit}";
    $result = mysqli_query($conn, $query);
            // echo $table_search;
        }else{
            // echo $table_search;
            $query = "SELECT * FROM orders WHERE order_id LIKE '%$table_search%' or  products LIKE '%$table_search%' or  agent_name LIKE '%$table_search%' ORDER BY order_id DESC LIMIT {$offset},{$limit}";
    $result = mysqli_query($conn, $query);
        }
