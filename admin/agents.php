...
$table_search = "";
        ...
        if($table_search == ""){
            $query = "SELECT * FROM agents ORDER BY id DESC LIMIT {$offset},{$limit}";
    $result = mysqli_query($conn, $query);
            // echo $table_search;
        }else{
            // echo $table_search;
            $query = "SELECT * FROM agents WHERE name LIKE '%$table_search%' or  mob_no LIKE '%$table_search%'  or  email LIKE '%$table_search%'  or  address LIKE '%$table_search%'  or  company LIKE '%$table_search%'  ORDER BY id DESC LIMIT {$offset},{$limit}";
    $result = mysqli_query($conn, $query);
        }
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <div class="row">
                                <div class="col">
                                    <p class="text-primary m-0 fw-bold">Agent Info</p>
                                </div>
                                <div class="col" style="text-align: right;"><a class="btn btn-primary" role="button" style="text-align: left;" href="add_agent.php">+ Add</a></div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 text-nowrap">
                                    <div id="dataTable_length" class="dataTables_length" aria-controls="dataTable"><label class="form-label">Show&nbsp;<select class="d-inline-block form-select form-select-sm" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                                                <option value="agents.php?limit=10" <?php 
                                                if(!(isset($_GET['limit'])) || ($_GET['limit'] == 10)){
                                                    echo 'selected';
                                                }
                                            ?>>10</option>
                                                <option value="agents.php?limit=25" <?php 
                                                if(isset($_GET['limit']) && ($_GET['limit'] == 25)){
                                                    echo 'selected';
                                                }
                                            ?>>25</option>
                                                <option value="agents.php?limit=50" <?php 
                                                if(isset($_GET['limit']) && ($_GET['limit'] == 50)){
                                                    echo 'selected';
                                                }
                                            ?>>50</option>
                                                <option value="agents.php?limit=100" <?php 
                                ...
                                <div class="col-md-6">
                                    <div class="text-md-end dataTables_filter" id="dataTable_filter">
                                        <form class="d-none d-sm-inline-block me-auto ms-md-3 my-2 my-md-0 mw-100 navbar-search" method="POST" action="agents.php">
                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td> <?php echo $data['slab']; ?> </td>
                                            <td>
                                                <a class="btn btn-primary" role="button" href="edit_agent.php?edit=<?php echo $data['id']; ?>" name="edit">Edit</a>
                                                <a class="btn btn-danger" role="button" href="agents.php?delete=<?php echo $data['id']; ?>" name="delete">Delete</a>
                                            </td>
                                        </tr>
                                    ...
                                    <tfoot>
                                        ...
                                        <td><strong>Name</strong></td>
                                            <td><strong>Mob Number</strong></td>
                                ...
                                <div class="col-md-6">
                                    <nav class="d-lg-flex justify-content-lg-end dataTables_paginate paging_simple_numbers">
                                        <ul class="pagination">
                                            <?php
                                            if($page > 1){
                                                echo '<li class="page-item"><a class="page-link" aria-label="Previous" href="agents.php?page='.($page -1).'"><span aria-hidden="true">«</span></a></li>';
                                            }else{
                                                echo '<li class="page-item disabled"><a class="page-link" aria-label="Previous" href="agents.php?page='.($page -1).'"><span aria-hidden="true">«</span></a></li>';
                                            }
                                            ...
                                            for($i =1; $i<=$total_page; $i++){
                                                ...
                                                echo '<li class="page-item '.$active.'"><a class="page-link" href="agents.php?page='.$i.'">'.$i.'</a></li>';
                                            }

                                            if($total_page > $page){
                                                echo '<li class="page-item"><a class="page-link" aria-label="Next" href="agents.php?page='.($page +1).'"><span aria-hidden="true">»</span></a></li>';
                                            }else{
                                                echo '<li class="page-item disabled"><a class="page-link" aria-label="Next" href="agents.php?page='.($page +1).'"><span aria-hidden="true">»</span></a></li>';
                                            }
