...
$table_search = "";
        ...
        if($table_search == ""){
            $query = "SELECT * FROM orders WHERE agent_name = '".$_SESSION['username']."' ORDER BY order_id DESC LIMIT {$offset},{$limit}";
    $result = mysqli_query($conn, $query);
            // echo $table_search;
        }else{
            // echo $table_search;
            $query = "SELECT * FROM orders  WHERE agent_name = '".$_SESSION['username']."' and (order_id LIKE '%$table_search%' or  products LIKE '%$table_search%') ORDER BY order_id DESC LIMIT {$offset},{$limit}";
    $result = mysqli_query($conn, $query);
        }
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 text-nowrap">
                                    <div id="dataTable_length" class="dataTables_length" aria-controls="dataTable"><label class="form-label">Show&nbsp;<select class="d-inline-block form-select form-select-sm" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                                                <option value="orders.php?limit=10" <?php 
                                                if(!(isset($_GET['limit'])) || ($_GET['limit'] == 10)){
                                                    echo 'selected';
                                                }
                                            ?>>10</option>
                                                <option value="orders.php?limit=25" <?php 
                                                if(isset($_GET['limit']) && ($_GET['limit'] == 25)){
                                                    echo 'selected';
                                                }
                                            ?>>25</option>
                                                <option value="orders.php?limit=50" <?php 
                                                if(isset($_GET['limit']) && ($_GET['limit'] == 50)){
                                                    echo 'selected';
                                                }
                                            ?>>50</option>
                                                <option value="orders.php?limit=100" <?php 
                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $data['products_price']; ?></td>
                                            <td><?php echo $data['order_status']; ?></td>
                                            <td><a class="btn btn-primary" role="button" href="order_details.php?details=<?php echo $data['order_id']; ?>" name="details">View all Details</a></td>
                                        </tr>
                                        <?php
                                        $sn++;
                                    }
                            ...
                            $sql = "SELECT * FROM orders WHERE agent_name = '".$_SESSION['username']."'";
                                ...
                                <div class="col-md-6">
                                    <nav class="d-lg-flex justify-content-lg-end dataTables_paginate paging_simple_numbers">
                                        <ul class="pagination">
                                            <?php
                                            if($page > 1){
                                                echo '<li class="page-item"><a class="page-link" aria-label="Previous" href="orders.php?page='.($page -1).'"><span aria-hidden="true">«</span></a></li>';
                                            }else{
                                                echo '<li class="page-item disabled"><a class="page-link" aria-label="Previous" href="orders.php?page='.($page -1).'"><span aria-hidden="true">«</span></a></li>';
                                            }
                                            ...
                                            if($total_page > $page){
                                                echo '<li class="page-item"><a class="page-link" aria-label="Next" href="orders.php?page='.($page +1).'"><span aria-hidden="true">»</span></a></li>';
                                            }else{
                                                echo '<li class="page-item disabled"><a class="page-link" aria-label="Next" href="orders.php?page='.($page +1).'"><span aria-hidden="true">»</span></a></li>';
                                            }
